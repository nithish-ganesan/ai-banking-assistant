...
export function LoginPage() {
  ...
  const isLinkedInInAppBrowser = /linkedin|linkedinapp|librowser/i.test(navigator.userAgent);
  const isIosLinkedInBrowser = /iP(hone|ad|od)/i.test(navigator.userAgent) && isLinkedInInAppBrowser;
