...
public final class BankingDtos {
    ...
    public record TransactionSummaryRequest(@NotEmpty List<@Valid @NotNull TransactionInput> transactions) {}
    ...
    public record EmiRequest(
            @NotNull @DecimalMin(value = "1.0") BigDecimal loanAmount,
    ...
    public record CardRecommendationRequest(
            @NotNull @DecimalMin(value = "0.0") BigDecimal salary,
